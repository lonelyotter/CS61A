...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        bee_armor_reduce = amount if amount < self.armor else amount + self.damage
        for bee in bees_copy:
            bee.reduce_armor(bee_armor_reduce)
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.digesting > 0:
            self.digesting += 1
            if self.digesting > self.time_to_digest + 1:
                self.digesting = 0
        if self.digesting == 0:
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return self.contained_ant == None and not isinstance(
            other, ContainerAnt)
        # END Problem 9
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self, armor=1):
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if QueenAnt.exist_queen == None:
            QueenAnt.exist_queen = self
        super().__init__(armor)
        # END Problem 13
    ...
    def action(self, gamestate):
        ...
        if QueenAnt.exist_queen is not self:
            ...
            while p != None:
                if p.ant != None:
                    ...
                    if isinstance(p.ant, ContainerAnt):
                        if p.ant.contained_ant != None:
                            double_damage(p.ant.contained_ant)
                p = p.exit
        # END Problem 13
    ...
    def reduce_armor(self, amount):
        ...
        if self is QueenAnt.exist_queen and self.armor <= 0:
            bees_win()
        # END Problem 13

    def remove_from(self, place):
        if self is QueenAnt.exist_queen:
            return
        else:
