...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            roll_score = take_turn(num_rolls, score1, dice)
            score0 += roll_score
            if feral_hogs == True and abs(num_rolls - prev_roll_score0) == 2:
                score0 += 3

            prev_roll_score0 = roll_score
            ...
            roll_score = take_turn(num_rolls, score0, dice)
            score1 += roll_score
            if feral_hogs == True and abs(num_rolls - prev_roll_score1) == 2:
                score1 += 3

            prev_roll_score1 = roll_score
